...
def test_builder_from_directory_with_dataset_info(
  ...
  builder = read_only_builder.builder_from_directory(
      code_builder.data_dir, info_proto=info_proto, features=features)
  ...
  assert builder.info.features == features
